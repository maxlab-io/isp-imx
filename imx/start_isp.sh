...
# check if the ov5647 device has been enabled in the device tree
        ...
        echo "Starting isp_media_server for Dual ov5647"

        cd $RUNTIME_DIR
        # Default configuration for OV5647: ov5647_1080p60
        # Available configurations: ov5647_1080p60
        exec ./run.sh -c dual_ov5647_1080p60 -lm
...
# check if the os08a20 device has been enabled in the device tree
	...
	if [ $NR_DEVICE_TREE_OV5640 -eq 0 ]; then
		...
		# Default configuration for os08a20: oa08a20_4k
		# Available configurations: Os08a20_4k, Os08a20_1080p60, Os08a20_4khdr, Os08a20_1080p60hdr
		exec ./run.sh -c os08a20_4k -lm

	elif [ $NR_DEVICE_TREE_OV5640 -eq 1 ]; then

		# Default configuration for os08a20: Os08a20_1080p60
		# Available configurations: Os08a20_1080p60, Os08a20_1080p60hdr
	...
	# Available configurations: dual_Os08a20_1080p60, dual_Os08a20_1080p60hdr, dual_Os08a20_1080p25hdr
